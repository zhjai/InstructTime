...
def get_hyperparams():
    ...
    parser.add_argument("--model_path", type=str, default="./results", help="the path to save model.")
    parser.add_argument("--load_model_path", type=str, default="./results", help="the path to load pretrained model.")
